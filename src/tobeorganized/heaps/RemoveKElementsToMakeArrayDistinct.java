 ...
 */
public class RemoveKElementsToMakeArrayDistinct {
  public static int findMaximumDistinctElements(int[] nums, int k) {
    ...
    for (int i : nums) numFrequencyMap.put(i, numFrequencyMap.getOrDefault(i, 0) + 1);
    ...
    for (Map.Entry<Integer, Integer> entry : numFrequencyMap.entrySet()) {
      if (entry.getValue() == 1) distinctElementsCount++;
  ...
  public static void main(String[] args) {
    int result =
        RemoveKElementsToMakeArrayDistinct.findMaximumDistinctElements(
