...
public class KClosestNumbersToGivenNumber {
  ...
  public static List<Integer> findClosestElements(int[] arr, int K, Integer X) {
    ...
    for (int i = low; i <= high; i++) minHeap.add(new Entry(Math.abs(arr[i] - X), i));
  ...
  public static void main(String[] args) {
    List<Integer> result =
        KClosestNumbersToGivenNumber.findClosestElements(new int[] {5, 6, 7, 8, 9}, 3, 7);
    System.out.println("'K' closest numbers to 'X' are: " + result);

    result = KClosestNumbersToGivenNumber.findClosestElements(new int[] {2, 4, 5, 6, 9}, 3, 6);
    System.out.println("'K' closest numbers to 'X' are: " + result);

    result = KClosestNumbersToGivenNumber.findClosestElements(new int[] {2, 4, 5, 6, 9}, 3, 10);
    System.out.println("'K' closest numbers to 'X' are: " + result);

    List<Integer> result1 =
        KClosestNumbersToGivenNumber.findClosestElementsTwoPointer(new int[] {5, 6, 7, 8, 9}, 3, 7);
    System.out.println("'K' closest numbers to 'X' are: " + result1);

    result1 =
        KClosestNumbersToGivenNumber.findClosestElementsTwoPointer(new int[] {2, 4, 5, 6, 9}, 3, 6);
    System.out.println("'K' closest numbers to 'X' are: " + result1);

    result1 =
        KClosestNumbersToGivenNumber.findClosestElementsTwoPointer(
            new int[] {2, 4, 5, 6, 9}, 3, 10);
    System.out.println("'K' closest numbers to 'X' are: " + result1);
  }
}
