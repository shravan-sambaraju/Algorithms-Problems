...
public class PermutationsOfNumbers {
  ...
  private static void generatePermutationsRecursive(
      int[] nums, int index, List<Integer> currentPermutation, List<List<Integer>> result) {
  ...
  public static void main(String[] args) {
    List<List<Integer>> result = PermutationsOfNumbers.generatePermutations(new int[] {1, 3, 5});
