...
public class CutRibbonMaxPiecesOfTargetLength {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(cr.countRibbonPiecesBottomUp(ribbonLengths, 13));
  ...
  private int countRibbonPiecesRecursive(int[] ribbonLengths, int total, int currentIndex) {
    ...
    if (ribbonLengths.length == 0 || currentIndex >= ribbonLengths.length) return Integer.MIN_VALUE;
