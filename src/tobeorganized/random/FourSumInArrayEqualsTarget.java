...
public class FourSumInArrayEqualsTarget {
  ...
  private static void searchPairs(
      int[] arr, int targetSum, int first, int second, List<List<Integer>> quadruplets) {
    int left = second + 1;
  ...
  public static void main(String[] args) {
    System.out.println(
        FourSumInArrayEqualsTarget.searchQuadruplets(new int[] {4, 1, 2, -1, 1, -3}, 1));
    System.out.println(
        FourSumInArrayEqualsTarget.searchQuadruplets(new int[] {2, 0, -1, 1, -2, 2}, 2));
  }
}
