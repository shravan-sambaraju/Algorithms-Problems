...
public class DeletionsToMakeSequenceSorted {

  public static void main(String[] args) {
    DeletionsToMakeSequenceSorted mdss = new DeletionsToMakeSequenceSorted();
  ...
  public int findMinimumDeletions(int[] nums) {
    // subtracting the length of LIS from the length of the input array to get minimum number of
    // deletions
