 ...
 * need to be completed before it can be scheduled. Given the number of tasks and a list of
 * prerequisite pairs, write a method to print all possible ordering of tasks meeting all
 * prerequisites.
 */
public class AllTaskSchedulingOrders {
  ...
  private static void printAllTopologicalSorts(
  ...
  private static Queue<Integer> cloneQueue(Queue<Integer> queue) {
    ...
    for (Integer num : queue) clone.add(num);
    return clone;
  }
  ...
  public static void main(String[] args) {
    ...
    AllTaskSchedulingOrders.printOrders(
