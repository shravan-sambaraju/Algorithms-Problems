 ...
 * problem, we need to find all those roots which give us MHTs. Write a method to find all MHTs of
...
public class MinimumHeightTrees {
  ...
  public static void main(String[] args) {
    ...
    result =
        MinimumHeightTrees.findTrees(
            4, new int[][] {new int[] {0, 1}, new int[] {0, 2}, new int[] {2, 3}});
    System.out.println("Roots of MHTs: " + result);

    result =
        MinimumHeightTrees.findTrees(
            4, new int[][] {new int[] {0, 1}, new int[] {1, 2}, new int[] {1, 3}});
    System.out.println("Roots of MHTs: " + result);
  }
}
