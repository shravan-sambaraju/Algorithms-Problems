...
public class PathWithGivenSequence {
  public static boolean findPath(BinaryTreeNode root, int[] sequence) {
  ...
  private static boolean findPathRecursive(
      BinaryTreeNode currentNode, int[] sequence, int sequenceIndex) {
    ...
    if (currentNode.left == null
        ...
        && sequenceIndex == sequence.length - 1) return true;
