...
public class FIllRectangleWithWords {
	 ...
	 * then check the Trie1 of words of length h to see if each partial
 ...
 class Trie1
{
    ...
    /* Takes a list of strings as an argument, and constructs a Trie1 that stores these strings. */
    ...
    /* Checks whether this Trie1 contains a string with the prefix passed
     * in as argument.
     */
