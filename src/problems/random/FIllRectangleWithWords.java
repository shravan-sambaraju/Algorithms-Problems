 ...
 * of letters such that every row forms a word (reading left to right) and every column forms a word
 * (reading top to bottom). The words need not be chosen consecutively from the list, but all rows
