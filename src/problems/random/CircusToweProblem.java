...
/* Implement circus tower of people  */
...
class CircusToweProblem {
  ...
  private static ArrayList<HtWt> longestIncreasingSeq(ArrayList<HtWt> array) {
  ...
  private static ArrayList<HtWt> initialize() {
    ...
    item = circus.new HtWt(70, 150);
    items.add(item);

    item = circus.new HtWt(56, 90);
    items.add(item);

    item = circus.new HtWt(75, 190);
    items.add(item);

    item = circus.new HtWt(60, 95);
    items.add(item);

    item = circus.new HtWt(68, 110);
    items.add(item);

    item = circus.new HtWt(35, 65);
    items.add(item);

    item = circus.new HtWt(40, 60);
    items.add(item);

    item = circus.new HtWt(45, 63);
    items.add(item);
  ...
  private class HtWt implements Comparable<HtWt> {
    private int height;
    private int weight;
    ...
    private boolean isBefore(HtWt other) {
