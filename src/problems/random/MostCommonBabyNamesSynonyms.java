 ...
 * listed separately in the list. Given two lists, one of names/frequencies and the other of pairs
 * of equivalent names, write an algorithm to print a new list of the true frequency of each name.
 * Note that if John and Jon are synonyms, and Jon and Johnny are synonyms, then John and Johnny are
 * synonyms. (It is both transitive and symmetric.) In the final list, any name can be used as the
 * "real " name.
 */
