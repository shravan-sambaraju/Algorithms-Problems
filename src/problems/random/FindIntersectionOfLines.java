...
class Line {
	...
	public Line(Point start, Point end) {
		...
		slope = deltaY / deltaX; // Will be Infinity (not exception) when deltaX
									// = 0
...
public class FindIntersectionOfLines {
	...
	public static Point intersection(Point start1, Point end1, Point start2, Point end2) {
		 ...
		 * and point 1 is before point 2. This will make some of the later logic
		 * simpler.
		 */
		if (start1.x > end1.x)
			swap(start1, end1);
		...
		/*
		 * If the lines are parallel, they intercept only if they have the same
		 * y intercept and start 2 is on line 1.
		 */
