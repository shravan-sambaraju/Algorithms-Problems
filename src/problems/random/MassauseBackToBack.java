...
/**
 * A popular masseuse receives a sequence of back-to-back appointment requests and is debating which
 * ones to accept. She needs a 15 minute break between appointments and therefore she cannot accept
 * any adjacent requests. Given a sequence of back-to-back appointment requests (all multiples of 15
 * minutes, none overlap, and none can be moved), find the optimal (highest total booked minutes)
