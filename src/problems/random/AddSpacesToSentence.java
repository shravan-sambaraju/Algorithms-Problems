...
public class AddSpacesToSentence {
	...
	public static ParseResult split(HashSet<String> dictionary, String sentence, int start, ParseResult[] memo) {
		...
		while (index < sentence.length()) {
			...
			if (invalid < bestInvalid) { // Short circuit
				/*
				 * Recurse, putting a space after this character. If this is
				 * better than the current best option, replace the best option.
				 */
	...
	static HashSet<String> getWordListAsHashSet() {
