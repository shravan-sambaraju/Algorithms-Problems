...
class InsertElementIntoBinaryTree {
	...
	public static void main(String args[]) {
		...
		System.out.println(insertElementIntoTreeRecursive(node, 8).getLeft().getLeft().getLeft().getData());
		System.out.println(insertElementIntoTreeRecursive(node, 9).getLeft().getLeft().getRight().getData());
	}
}
